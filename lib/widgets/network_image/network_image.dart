...
String getImageUrl(String url) {
  return url.contains('http') || url.contains(Service.url!.replaceAll(Service.apiUrl!.replaceAll(Service.url!, ""), ''))
      ? url
      : Service.url! +
          (url.isNotEmpty
              ? url[0] == '/'
          ...
          ? () => Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => ImagePreview(
                    ...
                    index: imagePathList?.indexOf(getImageUrl(networkImagePath)) ?? 0,
